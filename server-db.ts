...
const initialExhibitors: SeedExhibitor[] = [
  ...
  {
    id: "9b3292fe-43dc-45cc-bf67-37c2a71f005b",
    displayName: "Galli Bio Labs",
    companyDescription: "Specialized Soil & Agronomy research laboratory, developing microbial trace elements to enhance root system resistance under variable precipitation.",
    email: "s.galli@foodagri.it",
    websiteUrl: "www.galliolabs.it",
    linkedinUrl: "https://www.linkedin.com/in/sandro-galli/",
    instagramUrl: "",
    xUrl: "",
    countryRegion: "Italy",
    annualRevenue: "Pre-revenue",
    currentMarkets: '["Italy"]',
    targetMarkets: '["Italy","European Union"]',
    importExportStatus: "Exporter",
    brandsRepresented: "Galli Bio Labs",
    primarySectors: '["Primary Production, Agritech & Smart Farming"]',
    targetBuyers: "Government & Institutions",
    boothSizeConfirmed: "None_Attendee",
    electricalNeeds: "Not needed",
    directoryConsent: true,
    exhibitorLeadId: "9b3292fe-57c4-4d4b-aefa-69591b91aae5",
    role: "Attendee"
  },
  {
    id: "5ced99b2-32a8-4ebd-94c0-fe3910cbe772",
    displayName: "Milano Food Policy Advisory",
    companyDescription: "B2B Agrarian policy consultancy advising municipalities and agricultural enterprises on EU food systems compliance and sustainable agtech integration.",
    email: "e.rossi@milanofood.org",
    websiteUrl: "www.milanofood.org",
    linkedinUrl: "https://www.linkedin.com/in/elena-rossi/",
    instagramUrl: "",
    xUrl: "",
    countryRegion: "Italy",
    annualRevenue: "$100K – $500K",
    ...
    importExportStatus: "Both",
    brandsRepresented: "Milano Food Advisory",
    primarySectors: '["Consumer & Regulatory"]',
    targetBuyers: "Investors & VCs",
    boothSizeConfirmed: "None_Attendee",
    electricalNeeds: "Not needed",
    directoryConsent: true,
    exhibitorLeadId: "5ced99b2-57c4-4d4b-aefa-69591b91aae6",
    role: "Attendee"
  },
  {
    id: "a25039f3-89ea-4c22-b5e1-9ea403ef8839",
    displayName: "Nestle Premium Sourcing",
    companyDescription: "Direct farm sourcing network, implementing technology-supported trace tools to power next-generation sustainable packaging, alternative proteins, and agritech.",
    email: "sourcing@nestle-corp.com",
    websiteUrl: "www.nestlesourcing.com",
    linkedinUrl: "",
    instagramUrl: "",
    xUrl: "",
    countryRegion: "Switzerland",
    annualRevenue: "$1B+",
    currentMarkets: '["European Union","United States","Canada"]',
    targetMarkets: '["South America","Asia Pacific"]',
    importExportStatus: "Both",
    brandsRepresented: "Nestle Premium Sourcing",
    primarySectors: '["Investment, Trade & Export","Food Processing & Equipment","Sustainable Packaging"]',
    targetBuyers: "Sponsors",
    boothSizeConfirmed: "20x20 Pavilion",
    electricalNeeds: "3-Phase Power, Internet",
    directoryConsent: true,
    exhibitorLeadId: "a25039f3-57c4-4d4b-aefa-69591b91aae7",
    role: "Sponsor"
  }
];
